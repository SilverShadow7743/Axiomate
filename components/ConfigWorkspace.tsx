...
/**
 * What actually arrived — read-only, beside the rules that decide what happens to it. See the
 * mail-log design: no triage, no reclassify, no reply from here (that already exists, on the
 * issue itself). This screen answers "what did we receive," nothing more.
 */
function MailLog({ state }: { state: WorkspaceState }) {
