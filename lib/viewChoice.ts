...
export const WORKSPACE_VIEWS = ['mywork', 'tree', 'board', 'calendar', 'portfolio', 'resourcing', 'applications', 'analytics', 'timesheet', 'inbox', 'mycalendar', 'mytodos', 'mail', 'people', 'commercial', 'milestones'] as const
