...
try {
  ...
  if (code === '28P01') {
    ...
    console.log('')
    console.log('  Fix it by running the generated setup as a superuser — it is idempotent,')
    console.log('  and it sets the role password to exactly what .env already holds:')
    console.log('')
